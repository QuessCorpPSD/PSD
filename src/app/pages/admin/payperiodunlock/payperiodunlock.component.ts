...
@Component({
  ...
  templateUrl: './payperiodunlock.component.html',
  styleUrl: './payperiodunlock.component.css'
})
export class PayperiodunlockComponent {
  userdetail: any;
  Username: any;
  Role: any;
  ...
  uploadDisplayedColumns: string[] = [
    'slNo', 'companycode', 'payperiod', 'name', 'loginid', 'lasttriggered', 'release'];
