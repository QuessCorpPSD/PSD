...
@Component({
  selector: 'app-partialsalaryrelease',
  ...
  templateUrl: './partialsalaryrelease.component.html',
  styleUrl: './partialsalaryrelease.component.css'
})
export class PartialsalaryreleaseComponent {
