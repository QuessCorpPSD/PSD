...
import { SalaryReleaseProcessService } from '../../../Service/Service/SalaryRequestNew/salary-release-process.service';
export const Pay_TOKEN = new InjectionToken<ISalaryReleaseProcess>('Pay_TOKEN');
...
export class SalaryReleaseProcessComponent {
  ...
  constructor(private decry: EncryptionService,
    private _sessionStoreage: SessionStorageService, @Inject(Pay_TOKEN) private service: ISalaryReleaseProcess,) { }
