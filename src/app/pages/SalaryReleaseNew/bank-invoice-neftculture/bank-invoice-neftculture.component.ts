...
import { BankInvoiceNEFTCultureService } from '../../../Service/Service/SalaryRequestNew/bank-invoice-neftculture.service';
...
@Component({
  ...
  imports: [CommonModule, MatTableModule, MatCheckboxModule, MatPaginatorModule, MatSort,
    ...
    MatIconModule, MatCardModule, CompanyComponent, CompanyallComponent],
