...
export class PaycodeaddComponent {
  ...
  constructor(@Inject(Paycode_TOKEN) private payCode: IPAycodeService, private dialogRef: MatDialogRef<PaycodeaddComponent>, @Inject(MAT_DIALOG_DATA) public editData: any, private _decrypt: EncryptionService, private _sessionStoreage: SessionStorageService,) { }
