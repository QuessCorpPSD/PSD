...
@Component({
  ...
  templateUrl: './clientgstlist.component.html',
  styleUrl: './clientgstlist.component.css',
  providers: [
    {
      provide: Pay_TOKEN,
...
export class ClientgstlistComponent {
  ...
  exportToExcel(): void {
    ...
    this.service.Export(userId).subscribe({
  ...
  onFileSelected(event: Event): void {
    ...
    this.service.PostClientGSTUpload(formData).subscribe({
  ...
  onDeleteRow(row: any) {
    ...
    this.service.DeleteClientGST(row.clientGstId, this.userdetail.user_Id).subscribe({
  ...
  AddTemplate(): void {
    ...
    FileSaver.saveAs(blob, `ClientGST_AddTemplate_${Date.now()}.xlsx`);
  }
  ...
  EditTemplate(): void {
    ...
    FileSaver.saveAs(blob, `ClientGST_EditTemplate_${Date.now()}.xlsx`);
  }
}
