...
export class InvoiceCancelComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['select'
    , 'pdfdownload', 'docDownload', 'invoice_Number', 'reRaiseInvoice','invoice_Date','irN_Status', 'company_Code','pay_Period','map_Name','amount', 'cgsT_Amount', 'sgsT_Amount', 'igsT_Amount', 'net_Amount', 'creditNote_Status', 'creditNoteNumber', 'cancelledOn','crn_IRN_Status','crn_IRN_Number','remarks'];
