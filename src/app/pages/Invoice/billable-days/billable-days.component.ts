...
export class BillableDaysComponent implements OnInit {
  ...
  displayedColumns = ['Company_Code', 'Company_Name', 'Pay_Period', 'employee_Code', 'employee_Name', 'billable_Days', 'wO_NUMBER', 'grN_NUMBER', 'oT_AMOUNT', 'otheR_ALLOWANCE', 'reimB_AMOUNT']
