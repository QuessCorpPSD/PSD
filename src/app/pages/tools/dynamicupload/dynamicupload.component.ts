...
export const Pay_TOKEN = new InjectionToken<IDynamicUpload>('Pay_TOKEN');
...
export class DynamicuploadComponent {
  ...
  constructor(
    ...
    @Inject(Pay_TOKEN) private service: IDynamicUpload, private decry: EncryptionService,
