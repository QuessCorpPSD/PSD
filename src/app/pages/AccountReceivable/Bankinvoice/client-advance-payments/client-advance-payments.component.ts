...
import { IClientAdvancePaymets } from '../../../../Repository/BankInvoice/BankInvoiceRepository/IClientAdvancepayments';
import { ClientadvancepaymentsService } from '../../../../Service/BankInvoice/BankInvoiceService/clientadvancepayments.service';
import { CompanyfilterComponent } from '../../companyfilter/companyfilter.component';
...
@Component({
  ...
  providers: [
    { provide: Common_TOKEN, useClass: ClientadvancepaymentsService }
  ],
