...
import { IClientAdvanceReport } from '../../../../Repository/BankInvoice/BankInvoiceRepository/IClientAdvanceReport';
import { ClientadvanceReportsService } from '../../../../Service/BankInvoice/BankInvoiceService/clientadvance-reports.service';
...
@Component({
  ...
  providers: [
    { provide: Common_TOKEN, useClass: ClientadvanceReportsService }
  ],
