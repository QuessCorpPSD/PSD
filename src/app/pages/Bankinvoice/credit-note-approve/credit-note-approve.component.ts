...
import { CompanyComponent } from '../../customers/company/company.component';
import { CompanyallComponent } from '../../../common/CompanyAll/companyall.component';


@Component({
  selector: 'app-credit-note-approve',
  imports: [CommonModule,
    ...
    CompanyallComponent,
    MatTooltipModule],
  templateUrl: './credit-note-approve.component.html',
  styleUrl: './credit-note-approve.component.css'
})
export class CreditNoteApproveComponent {
  ...
  SearchClick() {
    ...
    this.creditService.CreditNoteApproveSearch(payload).subscribe({
      next: (res: any) => {
  ...
  DownloadTemplate() {
    ...
    const templateData = [
      {
        Employeecode: "", invoicenumber: "", Remarks: "", Status: "", saprefno: "", CREDITNOTETYPE: ""
      }
    ];
    ...
    FileSaver.saveAs(blob, `CreditNoteApprove_Template.xlsx`);
  }
  ...
  onFileChange(event: any): void {
    ...
    if (this.excelFile) {
      ...
      this.creditService.UploadCreditNoteApprove(formData).subscribe({
        next: (res) => {
