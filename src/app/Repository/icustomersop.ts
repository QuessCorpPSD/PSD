...
export interface ICustomersop {
    ...
    GetSOPAnswer34(val: string, val2: string): Observable<APIResponse>;
    PostSOPAnswer40(val): Observable<APIResponse>;
    GetSOPAnswer40(val: string, val2: string): Observable<APIResponse>;
    ...
    GetSOPAnswer41(val: string, val2: string): Observable<APIResponse>;
    PostSOPAnswerCompliance42(val): Observable<APIResponse>;
    GetSOPAnswerCompliance42(val: string, val2: string): Observable<APIResponse>;
    PostSOPAnswerMinimumwages42(val): Observable<APIResponse>;
    GetSOPAnswerMinimumwages42(val: string, val2: string): Observable<APIResponse>;
    PostSOPAnswerDesignation42(val): Observable<APIResponse>;
    GetSOPAnswerDesignation42(val: string, val2: string): Observable<APIResponse>;
    PostSOPAnswerCLRA42(val): Observable<APIResponse>;
    GetSOPAnswerCLRA42(val: string, val2: string): Observable<APIResponse>;
